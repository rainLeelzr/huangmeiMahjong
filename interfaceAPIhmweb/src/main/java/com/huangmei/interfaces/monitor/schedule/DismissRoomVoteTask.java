 ...
 * 广播游戏开始
 */
public class DismissRoomVoteTask implements MonitorTask {

    private static final Logger log = LoggerFactory.getLogger(DismissRoomVoteTask.class);
    ...
    public void run() {
        try {
            roomService.dismissRoomVoteTask(roomId);
            success();
        } catch (Exception e) {
