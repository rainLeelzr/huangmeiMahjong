...
public class GameServiceTest extends AbstractTestClass {
     ...
     */
    @Test
    public void TestYingDuiDuiHu() throws IllegalAccessException, InstantiationException {
        // 测试数据
        Room room = new Room();
        room.setId(222);
        room.setPlayers(4);
        ...
        temp = mockYingDuiDuiHuData(room, roomMembers);
     ...
     */
    @Test
    public void TestYingGang() throws IllegalAccessException, InstantiationException {
        // 测试数据
        Room room = new Room();
        room.setId(222);
        room.setPlayers(4);
        ...
        temp = mockYingGangData(room, roomMembers);
        Long version = versionRedis.nowVersion(room.getId());
        //Long version = temp.getVersion();
     ...
     * 模拟出硬对对胡GameData
     */
    public MahjongGameData mockYingDuiDuiHuData(Room room, RoomMember[] roomMembers) {
        //硬对对胡{座位4,可以胡、}
        List<Mahjong> allMahjongs = MockComboMahjongList.getYingDuiDuiHuMahjongs();
        //硬七对  {座位2,可以碰、}, {座位3,可以胡、}
        //List<Mahjong> allMahjongs = MockComboMahjongList.getYingQiDuiMahjongs();
     ...
     * 模拟出硬杠GameData
     */
    public MahjongGameData mockYingGangData(Room room, RoomMember[] roomMembers) {
        //硬对对胡{座位4,可以胡、}
        //List<Mahjong> allMahjongs = MockComboMahjongList.getYingDuiDuiHuMahjongs();
        //硬七对  {座位2,可以碰、}, {座位3,可以胡、}
        //List<Mahjong> allMahjongs = MockComboMahjongList.getYingQiDuiMahjongs();
